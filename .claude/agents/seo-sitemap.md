---
name: seo-sitemap
description: 🔧 Pillar 1 — Technical Foundation. Sitemap architect. Validates XML sitemaps, generates new ones with industry templates, and enforces quality gates for location pages.
