...
description: >
  ...
  "Core Web Vitals", "site speed", "security headers", "indexing problems",
  "pages not being indexed", "crawl budget", "redirect issues", "canonical
  issues", "mobile SEO", "JavaScript SEO", "page speed", "INP", "LCP", "CLS",
  "HTTPS issues", or "sitemap not found". Also use when a user reports
  unexplained ranking drops or crawling/indexing anomalies in Search Console.
---
...
### 6. Core Web Vitals
- **LCP** (Largest Contentful Paint): target <2.5s — see `../../seo/references/cwv-thresholds.md` for full thresholds
...
> 3-pillar SEO report. Findings feed directly into the Technical Foundation
> section score (35% of overall Health Score).

### Technical Score: XX/100

| Sub-category | Score | Status |
|-------------|-------|--------|
| Crawlability & Indexability | XX/100 | ✅/⚠️/❌ |
| Performance (Core Web Vitals) | XX/100 | ✅/⚠️/❌ |
| Mobile & JS Rendering | XX/100 | ✅/⚠️/❌ |
