...
description: >
  ...
  "wrong country showing in search", "targeting different countries",
  "geo-targeting", "language targeting", "hreflang errors", "international
  targeting", or "site in multiple languages". Also use when a user reports
  the wrong language version appearing in search results.
---
