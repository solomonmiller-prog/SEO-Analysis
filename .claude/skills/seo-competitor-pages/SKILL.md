...
description: >
  ...
  "alternatives page", "competitor comparison", "X vs Y", "best alternatives",
  "compare tools", "write a comparison", "versus page", "competitor landing page",
  "comparison article", "alternatives to [product]", or "best [category] tools"
  page. Always use this skill for any content designed to capture competitor or
  comparison-intent search traffic.
---
