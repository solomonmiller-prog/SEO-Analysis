...
description: >
  ...
  "generated pages", "data-driven SEO", "bulk page creation", "location pages
  at scale", "auto-generate pages", "city pages", "thousands of pages",
  "programmatic content", or "scaled content". Also use when a user wants to
  create many similar pages from a spreadsheet, database, or API.
---
