...
description: >
  ...
  "image audit", "WebP", "image compression", "images hurting my LCP",
  "image lazy loading", "missing alt text", "image CLS", "optimize images",
  "image format", or "images too slow".
---
...
> 3-pillar SEO report. Findings feed into Images & Media
> (7% of overall Health Score).
