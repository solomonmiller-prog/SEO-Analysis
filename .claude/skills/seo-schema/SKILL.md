...
description: >
  ...
  "JSON-LD", "markup", "schema validation", "add schema", "schema errors",
  "rich snippets", "star ratings in search", "review schema", "product schema",
  "local business schema", or "breadcrumb schema". Also use when a user asks
  why their rich results aren't showing in Google.
---
...
> 3-pillar SEO report. Findings feed into Schema & Structured Data
> (8% of overall Health Score). — detection and validation results
