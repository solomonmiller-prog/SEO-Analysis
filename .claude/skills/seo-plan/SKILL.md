...
description: >
  ...
  "site architecture", "SEO roadmap", "keyword strategy", "keyword research",
  "starting SEO from scratch", "new website SEO", "how do I rank for",
  "build an SEO strategy", "competitive analysis", "content calendar",
  "SEO for my business", or "where do I start with SEO".
---
...
Load from `assets/` directory (located within `skills/seo-plan/assets/`):
